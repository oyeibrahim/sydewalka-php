...
class Setting extends CI_Controller {
	...
	public function index()
	{
		...
		#-------------------------------#
		//delete previous pictures from the site if new image were uploaded
		if($logo){
			unlink($this->input->post('old_logo'));
		}
		if($logo_web){
			unlink($this->input->post('old_web_logo'));
		}
		if($favicon){
...
*/   
	...
	public function update_email_gateway()
	{
		...
		$data = array(
			...
			'password' 	=>$pass,
			'password_first_part'	=>$this->input->post('pass_first_part'),
			'password_second_part'	=>$this->input->post('pass_second_part'),

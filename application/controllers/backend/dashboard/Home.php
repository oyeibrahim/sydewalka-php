...
class Home extends CI_Controller 
{
    ...
    { 
        ...
        $this->form_validation->set_rules('alt_email', 'Alt Address', "required|valid_email|max_length[500]");
        ...
        $data['user'] = (object)$userData = array(
            ...
            'password'    => password_hash($this->input->post('password'), PASSWORD_BCRYPT), //hash password with BCRYPT

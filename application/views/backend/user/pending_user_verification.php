        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
				...
				<?php echo form_hidden('user_id', $user->user_id) ?>
                	...
                	<div class="form-group row">
                        <label for="cid" class="col-sm-4 col-form-label">Middle Name</label>
                        <div class="col-sm-8">
                            <?php echo $user->middle_name ?></span>
                        </div>
                    </div>
                	<div class="form-group row">
                        <label for="cid" class="col-sm-4 col-form-label">Country</label>
                        <div class="col-sm-8">
                            <?php echo $user->country ?></span>
                        </div>
                    </div>
                	<div class="form-group row">
                        <label for="cid" class="col-sm-4 col-form-label">Phone</label>
                        <div class="col-sm-8">
                            <?php echo $user->phone ?></span>
                        </div>
                    </div>
                	<div class="form-group row">
                        <label for="cid" class="col-sm-4 col-form-label">City</label>
                        <div class="col-sm-8">
                            <?php echo $user->city ?></span>
                        </div>
                    </div>
                	<div class="form-group row">
                        <label for="cid" class="col-sm-4 col-form-label">Address</label>
                        <div class="col-sm-8">
                	...
                	<div class="form-group row">
                        <label for="cid" class="col-sm-4 col-form-label">Passport/NID/License Number</label>
                        <div class="col-sm-8">
                	...
                	<div class="form-group row">
                        <label for="cid" class="col-sm-4 col-form-label">Doc III</label>
                        <div class="col-sm-8">
                        <?php if ($user->document3) { ?>
                            <img src="<?php echo base_url($user->document3); ?>" class="img-responsive"/>
                            <a href="<?php echo base_url($user->document3); ?>" class="btn btn-success" download="<?php echo $user->first_name."_".$user->user_id."_3"; ?>">Download File</a>	
                        <?php } ?>
                        </div>
                    </div>
                	<div class="form-group row">
                	...
                	<div class="form-group row">
                        <label for="cid" class="col-sm-4 col-form-label">Rejection Reason <small>(if to be rejected)</small></label>
                        <div class="col-sm-8">
                            <input name="reason" type="text" class="form-control" id="reason" placeholder="Must Be Entered if KYC will be Rejected" value="">
                        </div>
                    </div>
                    <?php } ?>
                	<div class="form-group row">
					...
					<div>
                        <button type="submit" name="cancel" class="btn btn-danger" >Disapprove</button>

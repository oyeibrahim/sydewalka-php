                    ...
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('backend/dashboard/setting/index','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <img src="<?php echo base_url($setting->favicon) ?>" alt="Favicon" class="img-thumbnail" style="max-width:300px" />
                                </div>
                            </div>
                            <?php } ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <img src="<?php echo base_url($setting->logo) ?>" alt="Picture" class="img-thumbnail" style="max-width:300px" />
                                </div>
                            </div>
                            <?php } ?>
                            ...
                            <div class="form-group row">
                                <label for="logoPreview" class="col-xs-3 col-form-label"></label>
                                <div class="col-xs-9">
                                    <img src="<?php echo base_url($setting->logo_web) ?>" alt="Picture" class="img-thumbnail" style="max-width:300px" />
                                </div>
                            </div>
                            <?php } ?>

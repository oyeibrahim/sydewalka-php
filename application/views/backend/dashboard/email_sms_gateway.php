        ...
        <div class="panel panel-bd ">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                    <div class="col-sm-12 img-thumbnail"><h3>SMS Gateway Setup</h3></div>
                    <hr>
                    <hr>
                    <hr>
                    ...
                    <div class="col-sm-12 img-thumbnail"><h3>Email Gateway Setup</h3></div>
                    <hr>
                    <hr>
                    <hr>
                        ...
                        <div class="form-group row">
                            <label for="email_user" class="col-xs-3 col-form-label"><?php echo "User" ?> <i class="text-danger">*</i></label>
                            <div class="col-xs-9">
                        ...
                        <div class="form-group row">
                            <label for="pass_first_part" class="col-xs-3 col-form-label"><?php echo "Password First Part" ?> <small>[only for dynamic sending]</small> <i class="text-danger">*</i></label>
                            <div class="col-xs-9">
                                <input name="pass_first_part" type="password" class="form-control" id="pass_first_part" placeholder="<?php "Password First Part" ?>" value="<?php echo $email->password_first_part ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="pass_second_part" class="col-xs-3 col-form-label"><?php echo "Password Second Part" ?> <small>[only for dynamic sending]</small> <i class="text-danger">*</i></label>
                            <div class="col-xs-9">
                                <input name="pass_second_part" type="password" class="form-control" id="pass_second_part" placeholder="<?php "Password Second Part" ?>" value="<?php echo $email->password_second_part ?>">
                            </div>
                        </div>
                        <div class="form-group row">

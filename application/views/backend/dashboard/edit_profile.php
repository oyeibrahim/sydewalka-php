    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    <label for="alt_email" class="col-sm-3 col-form-label">Alt Email Address *</label>
                    <small>For receiving Auth code and alerts. May be the same as the email above</small>
                    <div class="col-sm-9">
                        <input name="alt_email" class="form-control" type="text" placeholder="Alt Email Address" id="alt_email" value="<?php echo $user->alt_email ?>">
                    </div>
                </div>

        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('id', $slider->id) ?> 
                    ...
                    <div class="form-group row">
                        <label for="order_num" class="col-sm-4 col-form-label">Order Num <small>[for ordering the display]</small></label>
                        <div class="col-sm-8">
                            <input name="order_num" value="<?php echo htmlspecialchars($slider->order_num); ?>" class="form-control" type="text" id="order_num">
                        </div>
                    </div>
                    <div class="form-group row">

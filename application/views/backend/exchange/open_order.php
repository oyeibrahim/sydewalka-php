            ...
            <div class="panel-body">
                <table class="datatable2 table table-bordered table-hover" style="font-size:10px">
                    ...
                    <tbody id="useropenTrade">
                        <?php  foreach ($open_trades as $key => $value) { ?>
                            <tr>
                                <td><?php echo $No++; ?></td>
                                ...
                                <td><?php echo ($value->status == 2)?"RUNNING":"PENDING TRIGGER"; ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
                ...
                <?php if($userReq > 1){ ?>
                    <li class="page-item <?php echo ($userReq <= 1)?"disabled":"" ?>">
                        <a class="page-link" href="<?php echo base_url("backend/exchange/exchange/open_order/"). ((int)$userReq-1) ?>">

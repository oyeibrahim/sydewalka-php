        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', $article->article_id) ?> 
                    ...
                    <div class="form-group row">
                        <label for="article2_en" class="col-sm-2 col-form-label"><?php echo display('article_en')." 2" ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="article2_fr" class="col-sm-2 col-form-label"><?php echo display('article')." ".$web_language->name." 2" ?></label>
                        <div class="col-sm-10">

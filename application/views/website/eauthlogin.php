    ...
    <div class="container py-lg-3 div_cont" id="div_cont">
        ...
        <div class="col-lg-6 px-xl-5 offset-lg-3 div_helper1" id="div_helper1">
            ...
            <div class="pb-5 col-sm-12 shadow-lg cont_main1" id="cont_main1">
                ...
                <?php echo form_open('login-verify', 'id="loginverifyFrom" name="loginverifyFrom" onsubmit="return validateEmailAuthForm()" '); ?>

                <div class="text-center mb-4" style="padding-top:10px;">
                    <h1 class="h3 mb-3 font-weight-normal border-bottom">Email Auth</h1>
                </div>
                ...
                <div class="form-group">
                    <label for="e_name"><i class="fas fa-lock"></i>Email Verification Code</label>
                    <input type="text" class="form-control" id="token" name="token" placeholder="1234567" autocomplete="off" onkeyup="checkInputRequired(7,this.id)" autofocus>
                </div>

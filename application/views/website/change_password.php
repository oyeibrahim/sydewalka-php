    ...
    <div class="container py-lg-3 div_cont" id="div_cont">
        ...
        <div class="col-lg-6 px-xl-5 offset-lg-3 div_helper1" id="div_helper1">
            ...
            <div class="col-sm-12 pb-5 shadow-lg cont_main1" id="cont_main1">
                ...
                <?php echo form_open('change-password', 'id="changePassword" name="changePassword" onsubmit="return validateForm()" '); ?>

                <div class="text-center mb-4" style="padding-top:10px;">
                    <h1 class="h3 mb-3 font-weight-normal border-bottom">Change Password</h1>
                    <p>
                ...
                <div class="form-group">
                    <label for="old_pass"><i class="fas fa-lock"></i>Enter Old Password</label>
                    <div class="input-group">
                        <input type="password" class="form-control" id="old_pass" name="old_pass" placeholder="************" data-toggle="password" onkeyup="checkPassword(this.id)">
                    </div>
                </div>

                <div class="form-group">
                    <label for="new_pass"><i class="fas fa-lock"></i>Enter New Password</label>
                    <div class="input-group">
                        <input type="password" class="form-control" id="new_pass" name="new_pass" placeholder="************" data-toggle="password" onfocus="password_focus()" onblur="password_blur()" onkeyup="checkPassword(this.id)">
                ...
                <div class="form-group">
                    <label for="confirm_pass"><i class="fas fa-lock"></i>Confirm New Password</label>
                    <div class="input-group">
                        <input type="password" class="form-control" id="confirm_pass" name="confirm_pass" placeholder="************" data-toggle="password" onkeyup="checkConfirmPassword('new_pass',this.id)">
                    </div>
                </div>



                <button type="submit" class="btn btn-block submit_btn mt-4" id="anime_call">Change Password</button>

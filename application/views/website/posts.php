    ...
    <div class="container py-lg-3 px-0 div_cont" id="div_cont">
        ...
        <div class="col-lg-12 p-0 div_helper1" id="div_helper1">
            ...
            <div class="row m-0 justify-content-between">
                <div class="p-1">
                    <p class="m-0 mt-3 mx-3 mb-1 font-weight-bold">LiboPro Posts</p>
                </div>
            ...
            <div class="row m-0">
                ...
                <div class="col-lg-6 p-2 px-lg-4">
                ...
                <div class="col-lg-6 p-2 px-lg-5">
                    ...
                    <div class="col-12 p-0 mt-1 mb-5 e_border">
                        ...
                        <div class="e_nav text-center p-1">
                            <p class="m-0 p-0" style="font-weight: bold;">LISTED COIN SYMBOL DETAILS</p>
                        </div>
                        ...
                        <div class="p-0 my-3">
                            ...
                            <?php foreach ($symbol_detail as $key => $value) { ?>
                        ...
                        <div class="text-right pr-2 view_all mb-3" style="font-size: small;">
                            <a href="<?php echo base_url("posts/symbol-detail") ?>">View All News ...</a>
                        </div>
